...
console.log(observation_trials_repeats_allowed);
...
var production_trials_unshuffled = jsPsych.randomization.repeat(
  [
    production_trial_object4,
    production_trial_object5,
    production_trial_object6,
  ],
  5
);

//Shuffle to avoid them, as before
var production_trials = jsPsych.randomization.shuffleNoRepeats(
  production_trials_unshuffled,
  function (trial1, trial2) {
    return trial1.stimulus == trial2.stimulus;
  }
);
